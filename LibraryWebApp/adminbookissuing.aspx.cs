...
namespace LibraryWebApp
{
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Неправильный Книги ID или Клиент ID');</script>");
            }
        }
        // кнопка вернуть
        ...
        void getNames()
        {
            try
            {
                ...
                {
                    Response.Write("<script>alert('Неправильный Книги ID');</script>");
                }
                ...
                {
                    Response.Write("<script>alert('Неправильный Клиент ID');</script>");
                }
            }
            catch (Exception ex)
            {
