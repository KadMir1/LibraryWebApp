...
namespace LibraryWebApp
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Книга уже существует, поппробуйте другой ID');</script>");
            }
            else
            {
                addNewBook();
        ...
        void deleteBookByID()
        {
            ...
            {
                Response.Write("<script>alert('Неверный ID.');</script>");
            }
        }
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Response.Write("<script>alert('Некорректное количество книг');</script>");
                            return;
                    ...
                    con.Close();
                    GridView1.DataBind();
                    Response.Write("<script>alert('Книга обновлена');</script>");
